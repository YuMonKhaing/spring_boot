...
import com.crud.demo.repository.TutorialRepository;
...
public class TutorialController {
    ...
    public String getAll(Model model, @Param("keyword") String keyword) {
        try {
            ...
            if (keyword == null) {
                ...
                tutorialRepository.findByDescriptionContainingIgnoreCase(keyword).forEach(tutorials::add);
    ...
    public String saveTutorial(@Valid @ModelAttribute("tutorial") Tutorial tutorial, BindingResult bindingResult,
